...
import { useSecureDeviceId } from './src/hooks/useSecureDeviceId';
import { DeviceIdContext } from './src/contexts/DeviceIdContext';
...
const App = () => {
  const { deviceId, loading } = useSecureDeviceId();
